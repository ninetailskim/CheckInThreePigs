...
class FlappyBird(base.PyGameWrapper):
    ...
    def _load_images(self):
        ...
        image_assets = [
            os.path.join(self._asset_dir, "paddle-up.png"),
            os.path.join(self._asset_dir, "paddle-down.png"),
        ]

        self.images["player"] = [pygame.image.load(
    ...
    def init(self):
        ...
        self.player.init(self.init_pos)
